...
<link rel="stylesheet" href="portfolio.css">
  ...
  <title>Sampangi Venkata Manikanta</title>
 ...
 <meta property="og:title" content="Sampangi Venkata Manikanta">
...
<meta name="twitter:title" content="Sampangi Venkata Manikanta">
  ...
  <header class="header">
    <nav class="navbar">
      <div class="navbar-container container">
        <div>
          <h1 class="navbar-brand">Sampangi Venkata Manikanta</h1>
        </div>
        <ul class="menu-items">
    ...
    <div class="home-content" id="home-page">
      <div class="name">
        <h1>Hi, I'm Manikanta</h1>
        <p>A Web Developer and AWS cloud Practioner.</p>
      </div>
    ...
    <div class="container">
      <div class="about-content">
        <div class="left-content">
          ...
          <p>
            I am 20 year old, currently pursuing my B.Tech in the field of Computer Science and Enginnering student studying at Sagi Ramakrishnam Raju Engineering
            College.I really enjoy solving problems as well as making things pretty and easy to use. I can't stop learning new
  ...
  <section id="my-works">
    <div class="portfolio">
      ...
      <div class="portfolio-content container">
        <div class="proj-1">
          <img src="https://github.com/manikantasampangi/AWS-Project-Architecture/assets/136771900/7294533d-c427-4638-87ba-e3655971eeb2">
          <div class="proj1-details">
            <i class="fab fa-aws"></i>
            <h2>Global Request Distribution Architecture for Webpage Access with Autoscaling, EFS and SNS Services</h2>
            <p>Implemented on AWS Cloud</p>
            <button><a href="https://github.com/manikantasampangi/AWS-Project-Architecture" target="blank">View source <i
  ...
  <div class="contact" id="contact-me">
    <div class="container">
      <div class="contact-content">
        <h2>Contact Me</h2>
        <p class="mail">
          Get in touch with me <i class="fas fa-arrow-right"></i> manikantasandy2002@gmail.com
        </p>
        <p class="links">Or find me on:</p>
        <a href="https://www.linkedin.com/in/manikanta-sampangi-663709246" target="blank"><i class="fab fa-linkedin">
            Linkedin</i></a>
        <a href="https://github.com/manikantasampangi" target="blank"><i class="fab fa-github"></i> Github</a>
